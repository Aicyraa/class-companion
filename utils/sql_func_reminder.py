...
class Reminder_Query:
    ...
    def schedule_remind(): # function for fetching reminders
        ...
        try:
            ...
            print(f'Error occur while fetching schedule {err}')
        finally:
            cursor.close()
            cnx.close()
    ...
    def activity_remind():
        ...
        try:
         for (guild_id,) in cursor.fetchall(): 
            ...
            for announcement in cursor.fetchall():
                storage.append(announcement)

            result[guild_id] = storage
        
        except sql.Error as err:
            print(f'Error occur while fetching activities {err}')
        finally:
            cursor.close()
            cnx.close()
    ...
    def check_date():
        ...
        try:
            ...
            print(f'Error occur while deleting {err}')
        finally:
            cursor.close()
            cnx.close()
